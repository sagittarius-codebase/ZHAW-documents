...
requests_per_minute = 273 / 20
number_of_minutes = 10
maximum_of_requests = 154
...
print("The probability of the maximum of requests in", number_of_minutes, "minutes is:", round(P, 4), "\n")
...
# Replace the following with the values of your quiz:
correct_result_prob = 0.31
minimum_prob_for_correct_result = 0.94
...
# Replace the following with the values of your quiz:
number_of_tickets = 36 # N
number_of_luck_tickets = 8 # M
number_purchased_tickets = 5 # n
maximum_of_received_luck_tickets = 0 # if text sais: less than 2, then 1!
minimum_of_received_luck_tickets = 0
exactly_received_luck_tickets = 2
...
if minimum_of_received_luck_tickets == 0 and exactly_received_luck_tickets == 0:
    probability = 0
...
elif maximum_of_received_luck_tickets == 0 and exactly_received_luck_tickets == 0:
    probability = 0
    ...
    probability = comb(number_of_luck_tickets, exactly_received_luck_tickets) * comb(number_of_tickets - number_of_luck_tickets, number_purchased_tickets - exactly_received_luck_tickets) / comb(number_of_tickets, number_purchased_tickets)
    print("The probability of getting exactly the DEFINED number of luck-tickets is:", round(probability, 3), "\n")
